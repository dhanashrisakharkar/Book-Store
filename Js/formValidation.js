let validate =(event , id) => {
    ...
    // const textError = document.getElementById('.text-error').value;
    // const textErrorTwo = document.getElementById('.phone-error').value;
    // const textErrorThree = document.getElementById('.pincode-error').value;
